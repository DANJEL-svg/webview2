...
export default function HomeScreen({ navigation }) { 
    ...
    const[currentUrl,setCurrentUrl]=useState('https://easyalbania.com');
    const onPress = () => setCurrentUrl('https://easyalbania.com');
      ...
      <>
        ...
        ref={webviewref}
          ...
          onShouldStartLoadWithRequest={(request) => {
           ...
           if ( request.url.startsWith ('https://easyalbania.com')){
